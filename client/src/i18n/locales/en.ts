const en = {
  ...
  content: {
    ...
    subtitle: 'Build your curriculum and question inventory for this organization.',
    backToOrg: 'Back to organization',
    manageContent: 'Courses & banks',
    courses: 'Courses',
    ...
    points: 'Points',
    stem: 'Question text',
    correctIndex: 'Correct option index (0-based) or true/false',
    pts: 'pts',
  },
  errors: {
